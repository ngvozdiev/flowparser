...
module = Extension('fparser',
                   ...
                   extra_compile_args = ['-I/Library/Developer/CommandLineTools/usr/bin/../include/c++/v1', '-Wno-c++11-compat-deprecated-writable-strings',  '-g', '-pthread', '-std=c++11', '-pedantic-errors', '-Winit-self', '-Wno-old-style-cast',
                                         '-Woverloaded-virtual', '-Wuninitialized', '-Wextra', '-O2', '-Wno-missing-field-initializers'])
